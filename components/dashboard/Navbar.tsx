...
import { Bell, User, Settings, LogOut, AlertCircle, MessageSquare, AlertTriangle, CheckCircle, X } from "lucide-react";
            ...
            <AnimatePresence>
              {showNotifications && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-96 max-h-[600px] overflow-hidden rounded-xl border border-gray-200 bg-white shadow-xl z-50"
                >
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-start justify-between gap-2">
                                ...
                                {!notification.read && (
                                  <span className="h-2 w-2 shrink-0 rounded-full bg-indigo-600 mt-1" />
                                )}
                              </div>
                  ...
                  {notifications.length > 0 && (
                    <div className="border-t border-gray-200 px-4 py-3">
                      <Link
                        href="/"
                        onClick={() => setShowNotifications(false)}
                        className="text-sm font-medium text-indigo-600 hover:text-indigo-700 text-center block"
                      >
            ...
            {showProfileMenu && (
              ...
              >
                <Link
                  ...
                  className="flex items-center gap-2 rounded-t-xl px-4 py-2 hover:bg-gray-50"
                >
                ...
                <button
                  ...
                  className="flex w-full items-center gap-2 rounded-b-xl px-4 py-2 text-red-600 hover:bg-gray-50"
                >
