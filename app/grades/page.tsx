      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-gray-800 mb-2">Grades & Assessment</h1>
              <p className="text-gray-600">Your academic performance across all subjects</p>
            </div>
              ...
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-indigo-600">{monthStats.averagePercentage}%</div>
                    <p className="text-gray-600 text-sm mt-2">Average</p>
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-blue-600">{monthStats.totalMarks}/{monthStats.maxMarks}</div>
                    <p className="text-gray-600 text-sm mt-2">Total Marks</p>
                  </div>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="pt-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold text-green-600">{monthStats.count}</div>
                    <p className="text-gray-600 text-sm mt-2">Assessments</p>
                  </div>
                </CardContent>
              </Card>
            </div>
